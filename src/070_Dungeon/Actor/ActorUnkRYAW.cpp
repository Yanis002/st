...
extern ActorTypeUnkRYAW ActorTypeUnkRYAW::gInstance;

ARM ActorTypeUnkRYAW *ActorTypeUnkRYAW::GetInstance() {
    return &ActorTypeUnkRYAW::gInstance;
}

ARM Actor *ActorTypeUnkRYAW::Create() {
    return new(HeapIndex_2) ActorUnkRYAW();
}

ARM ActorTypeUnkRYAW::ActorTypeUnkRYAW() :
    ActorType(ActorId_RYAW) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkRYAW::ActorUnkRYAW() {}

ARM void ActorUnkRYAW::func_ov070_0214c0b4(void) {}
...
ARM void ActorUnkRYAW::func_ov070_0214db18(void) {}
ARM void ActorUnkRYAW::func_ov070_0214db34(void) {}
ARM void ActorUnkRYAW::func_ov070_0214db50(void) {}
