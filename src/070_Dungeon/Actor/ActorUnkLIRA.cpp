...
extern ActorTypeUnkLIRA ActorTypeUnkLIRA::gInstance;

ARM ActorTypeUnkLIRA *ActorTypeUnkLIRA::GetInstance() {
    return &ActorTypeUnkLIRA::gInstance;
}

ARM Actor *ActorTypeUnkLIRA::Create() {
    return new(HeapIndex_2) ActorUnkLIRA();
}

ARM ActorTypeUnkLIRA::ActorTypeUnkLIRA() :
    ActorType(ActorId_LIRA) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkLIRA::ActorUnkLIRA() {}

ARM void ActorUnkLIRA::func_ov070_0214286c(void) {}
ARM void ActorUnkLIRA::func_ov070_02142884(void) {}
ARM void ActorUnkLIRA::func_ov070_02142898(void) {}
ARM void ActorUnkLIRA::func_ov070_021428b4(void) {}
ARM void ActorUnkLIRA::func_ov070_021429ec(void) {}
...
ARM void ActorUnkLIRA::func_ov070_021435b0(void) {}
