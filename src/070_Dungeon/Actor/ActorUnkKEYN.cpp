...
extern ActorTypeUnkKEYN ActorTypeUnkKEYN::gInstance;

ARM ActorTypeUnkKEYN *ActorTypeUnkKEYN::GetInstance() {
    return &ActorTypeUnkKEYN::gInstance;
}

ARM Actor *ActorTypeUnkKEYN::Create() {
    return new(HeapIndex_2) ActorUnkKEYN();
}

ARM ActorTypeUnkKEYN::ActorTypeUnkKEYN() :
    ActorType(ActorId_KEYN) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkKEYN::ActorUnkKEYN() {}

ARM void ActorUnkKEYN::func_ov070_0214143c(void) {}
ARM void ActorUnkKEYN::func_ov070_021414e8(void) {}
...
ARM void ActorUnkKEYN::func_ov070_021426c8(void) {}
ARM void ActorUnkKEYN::func_ov070_021426f0(void) {}
ARM void ActorUnkKEYN::func_ov070_02142720(void) {}
