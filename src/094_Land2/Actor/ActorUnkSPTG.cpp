...
extern ActorTypeUnkSPTG ActorTypeUnkSPTG::gInstance;

ARM ActorTypeUnkSPTG *ActorTypeUnkSPTG::GetInstance() {
    return &ActorTypeUnkSPTG::gInstance;
}

ARM Actor *ActorTypeUnkSPTG::Create() {
    return new(HeapIndex_2) ActorUnkSPTG();
}

ARM ActorTypeUnkSPTG::ActorTypeUnkSPTG() :
    ActorType(ActorId_SPTG) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkSPTG::ActorUnkSPTG() {}

ARM void ActorUnkSPTG::func_ov094_0216c6ac(void) {}
ARM void ActorUnkSPTG::func_ov094_0216c7cc(void) {}
ARM void ActorUnkSPTG::func_ov094_0216c7e0(void) {}
ARM void ActorUnkSPTG::func_ov094_0216c800(void) {}
...
ARM void ActorUnkSPTG::func_ov094_0216daac(void) {}
