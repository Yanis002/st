...
extern ActorTypeUnkFIBB ActorTypeUnkFIBB::gInstance;

ARM ActorTypeUnkFIBB *ActorTypeUnkFIBB::GetInstance() {
    return &ActorTypeUnkFIBB::gInstance;
}

ARM Actor *ActorTypeUnkFIBB::Create() {
    return new(HeapIndex_2) ActorUnkFIBB();
}

ARM ActorTypeUnkFIBB::ActorTypeUnkFIBB() :
    ActorType(ActorId_FIBB) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkFIBB::ActorUnkFIBB() {}

ARM void ActorUnkFIBB::func_ov054_0213c2a0(void) {}
...
ARM void ActorUnkFIBB::func_ov054_0213d584(void) {}
ARM void ActorUnkFIBB::func_ov054_0213d5b4(void) {}
ARM void ActorUnkFIBB::func_ov054_0213d5ec(void) {}
