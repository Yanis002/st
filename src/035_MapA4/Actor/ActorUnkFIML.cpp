...
extern ActorTypeUnkFIML ActorTypeUnkFIML::gInstance;

ARM ActorTypeUnkFIML *ActorTypeUnkFIML::GetInstance() {
    return &ActorTypeUnkFIML::gInstance;
}

ARM Actor *ActorTypeUnkFIML::Create() {
    return new(HeapIndex_2) ActorUnkFIML();
}

ARM ActorTypeUnkFIML::ActorTypeUnkFIML() :
    ActorType(ActorId_FIML) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkFIML::ActorUnkFIML() {}

ARM void ActorUnkFIML::func_ov035_0211bc44(void) {}
...
ARM void ActorUnkFIML::func_ov035_0211e41c(void) {}
ARM void ActorUnkFIML::func_ov035_0211e438(void) {}
ARM void ActorUnkFIML::func_ov035_0211e460(void) {}
ARM void ActorUnkFIML::func_ov035_0211e490(void) {}
