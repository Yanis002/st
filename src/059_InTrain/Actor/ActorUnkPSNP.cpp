...
extern ActorTypeUnkPSNP ActorTypeUnkPSNP::gInstance;

THUMB ActorTypeUnkPSNP *ActorTypeUnkPSNP::GetInstance() {
    return &ActorTypeUnkPSNP::gInstance;
}

THUMB Actor *ActorTypeUnkPSNP::Create() {
    return new(HeapIndex_2) ActorUnkPSNP();
}

THUMB ActorTypeUnkPSNP::ActorTypeUnkPSNP() :
    ActorType(ActorId_PSNP) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkPSNP::ActorUnkPSNP() {}
...
ARM void ActorUnkPSNP::func_ov059_02160d98(void) {}
ARM void ActorUnkPSNP::func_ov059_02160db4(void) {}
ARM void ActorUnkPSNP::func_ov059_02160ddc(void) {}
ARM void ActorUnkPSNP::func_ov059_02160dfc(void) {}
