...
extern ActorTypeUnkZLSN ActorTypeUnkZLSN::gInstance;

ARM ActorTypeUnkZLSN *ActorTypeUnkZLSN::GetInstance() {
    return &ActorTypeUnkZLSN::gInstance;
}

ARM Actor *ActorTypeUnkZLSN::Create() {
    return new(HeapIndex_2) ActorUnkZLSN();
}

ARM ActorTypeUnkZLSN::ActorTypeUnkZLSN() :
    ActorType(ActorId_ZLSN) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkZLSN::ActorUnkZLSN() {}

ARM void ActorUnkZLSN::func_ov060_0215ee00(void) {}
...
ARM void ActorUnkZLSN::func_ov060_0215f234(void) {}
...
ARM void ActorUnkZLSN::func_ov060_02160120(void) {}
