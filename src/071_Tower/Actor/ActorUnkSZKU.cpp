...
extern ActorTypeUnkSZKU ActorTypeUnkSZKU::gInstance;

ARM ActorTypeUnkSZKU *ActorTypeUnkSZKU::GetInstance() {
    return &ActorTypeUnkSZKU::gInstance;
}

ARM Actor *ActorTypeUnkSZKU::Create() {
    return new(HeapIndex_2) ActorUnkSZKU();
}

ARM ActorTypeUnkSZKU::ActorTypeUnkSZKU() :
    ActorType(ActorId_SZKU) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkSZKU::ActorUnkSZKU() {}

ARM void ActorUnkSZKU::func_ov071_0215f290(void) {}
ARM void ActorUnkSZKU::func_ov071_0215f424(void) {}
ARM void ActorUnkSZKU::func_ov071_0215f438(void) {}
ARM void ActorUnkSZKU::func_ov071_0215f4b0(void) {}
...
ARM void ActorUnkSZKU::func_ov071_02160104(void) {}
