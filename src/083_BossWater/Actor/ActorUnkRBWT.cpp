...
extern ActorTypeUnkRBWT ActorTypeUnkRBWT::gInstance;

ARM ActorTypeUnkRBWT *ActorTypeUnkRBWT::GetInstance() {
    return &ActorTypeUnkRBWT::gInstance;
}

ARM Actor *ActorTypeUnkRBWT::Create() {
    return new(HeapIndex_2) ActorUnkRBWT();
}

ARM ActorTypeUnkRBWT::ActorTypeUnkRBWT() :
    ActorType(ActorId_RBWT) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkRBWT::ActorUnkRBWT() {}

ARM void ActorUnkRBWT::func_ov083_0215b760(void) {}
ARM void ActorUnkRBWT::func_ov083_0215b8c0(void) {}
ARM void ActorUnkRBWT::func_ov083_0215b8d4(void) {}
ARM void ActorUnkRBWT::func_ov083_0215b93c(void) {}
...
ARM void ActorUnkRBWT::func_ov083_0215c178(void) {}
