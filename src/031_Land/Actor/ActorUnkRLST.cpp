...
extern ActorTypeUnkRLST ActorTypeUnkRLST::gInstance;

ARM ActorTypeUnkRLST *ActorTypeUnkRLST::GetInstance() {
    return &ActorTypeUnkRLST::gInstance;
}

ARM Actor *ActorTypeUnkRLST::Create() {
    return new(HeapIndex_2) ActorUnkRLST();
}

ARM ActorTypeUnkRLST::ActorTypeUnkRLST() :
    ActorType(ActorId_RLST) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkRLST::ActorUnkRLST() {}
...
ARM void ActorUnkRLST::func_ov031_020f84e0(void) {}
...
ARM void ActorUnkRLST::func_ov031_020f9cd8(void) {}
ARM void ActorUnkRLST::func_ov031_020f9cf4(void) {}
ARM void ActorUnkRLST::func_ov031_020f9d10(void) {}
ARM void ActorUnkRLST::func_ov031_020f9d60(void) {}
ARM void ActorUnkRLST::func_ov031_020f9db8(void) {}
