...
extern ActorTypeUnkHERT ActorTypeUnkHERT::gInstance;

ARM ActorTypeUnkHERT *ActorTypeUnkHERT::GetInstance() {
    return &ActorTypeUnkHERT::gInstance;
}

ARM Actor *ActorTypeUnkHERT::Create() {
    return new(HeapIndex_2) ActorUnkHERT();
}

ARM ActorTypeUnkHERT::ActorTypeUnkHERT() :
    ActorType(ActorId_Heart) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkHERT::ActorUnkHERT() {}

ARM void ActorUnkHERT::func_ov031_020eed64(void) {}
ARM void ActorUnkHERT::func_ov031_020eede0(void) {}
...
ARM void ActorUnkHERT::func_ov031_020ef7d8(void) {}
ARM void ActorUnkHERT::func_ov031_020ef7f4(void) {}
ARM void ActorUnkHERT::func_ov031_020ef808(void) {}
