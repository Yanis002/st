...
extern ActorTypeUnkAJTM ActorTypeUnkAJTM::gInstance;

ARM ActorTypeUnkAJTM *ActorTypeUnkAJTM::GetInstance() {
    return &ActorTypeUnkAJTM::gInstance;
}

ARM Actor *ActorTypeUnkAJTM::Create() {
    return new(HeapIndex_2) ActorUnkAJTM();
}

ARM ActorTypeUnkAJTM::ActorTypeUnkAJTM() :
    ActorType(ActorId_AJTM) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkAJTM::ActorUnkAJTM() {}

ARM void ActorUnkAJTM::func_ov068_0215c0e8(void) {}
ARM void ActorUnkAJTM::func_ov068_0215c1ac(void) {}
ARM void ActorUnkAJTM::func_ov068_0215c1d0(void) {}
...
ARM void ActorUnkAJTM::func_ov068_0215cfa0(void) {}
