...
extern ActorTypeUnkNSSW ActorTypeUnkNSSW::gInstance;

ARM ActorTypeUnkNSSW *ActorTypeUnkNSSW::GetInstance() {
    return &ActorTypeUnkNSSW::gInstance;
}

ARM Actor *ActorTypeUnkNSSW::Create() {
    return new(HeapIndex_2) ActorUnkNSSW();
}

ARM ActorTypeUnkNSSW::ActorTypeUnkNSSW() :
    ActorType(ActorId_NSSW) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkNSSW::ActorUnkNSSW() {}

ARM void ActorUnkNSSW::func_ov032_0211fdf4(void) {}
...
ARM void ActorUnkNSSW::func_ov032_02120e08(void) {}
ARM void ActorUnkNSSW::func_ov032_02120e24(void) {}
