...
extern ActorTypeUnkBPBS ActorTypeUnkBPBS::gInstance;

ARM ActorTypeUnkBPBS *ActorTypeUnkBPBS::GetInstance() {
    return &ActorTypeUnkBPBS::gInstance;
}

ARM Actor *ActorTypeUnkBPBS::Create() {
    return new(HeapIndex_2) ActorUnkBPBS();
}

ARM ActorTypeUnkBPBS::ActorTypeUnkBPBS() :
    ActorType(ActorId_BPBS) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkBPBS::ActorUnkBPBS() {}

ARM void ActorUnkBPBS::func_ov096_0217adb8(void) {}
ARM void ActorUnkBPBS::func_ov096_0217add8(void) {}
ARM void ActorUnkBPBS::func_ov096_0217ae50(void) {}
...
ARM void ActorUnkBPBS::func_ov096_0217d180(void) {}
ARM void ActorUnkBPBS::func_ov096_0217d19c(void) {}
ARM void ActorUnkBPBS::func_ov096_0217d1b8(void) {}
ARM void ActorUnkBPBS::func_ov096_0217d1d4(void) {}
