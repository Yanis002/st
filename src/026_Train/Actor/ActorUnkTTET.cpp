...
extern ActorTypeUnkTTET ActorTypeUnkTTET::gInstance;

ARM ActorTypeUnkTTET *ActorTypeUnkTTET::GetInstance() {
    return &ActorTypeUnkTTET::gInstance;
}

ARM Actor *ActorTypeUnkTTET::Create() {
    return new(HeapIndex_2) ActorUnkTTET();
}

ARM ActorTypeUnkTTET::ActorTypeUnkTTET() :
    ActorType(ActorId_TTET) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkTTET::ActorUnkTTET() {}

ARM void ActorUnkTTET::func_ov026_02122f14(void) {}
ARM void ActorUnkTTET::func_ov026_02122f54(void) {}
...
ARM void ActorUnkTTET::func_ov026_021235d8(void) {}
ARM void ActorUnkTTET::func_ov026_021235ec(void) {}
ARM void ActorUnkTTET::func_ov026_02123608(void) {}
