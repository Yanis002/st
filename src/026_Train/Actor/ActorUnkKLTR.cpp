...
extern ActorTypeUnkKLTR ActorTypeUnkKLTR::gInstance;

ARM ActorTypeUnkKLTR *ActorTypeUnkKLTR::GetInstance() {
    return &ActorTypeUnkKLTR::gInstance;
}

ARM Actor *ActorTypeUnkKLTR::Create() {
    return new(HeapIndex_2) ActorUnkKLTR();
}

ARM ActorTypeUnkKLTR::ActorTypeUnkKLTR() :
    ActorType(ActorId_KLTR) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkKLTR::ActorUnkKLTR() {}

ARM void ActorUnkKLTR::func_ov026_021116e0(void) {}
ARM void ActorUnkKLTR::func_ov026_021116f0(void) {}
ARM void ActorUnkKLTR::func_ov026_0211185c(void) {}
ARM void ActorUnkKLTR::func_ov026_021118e4(void) {}
...
ARM void ActorUnkKLTR::func_ov026_02113d28(void) {}
