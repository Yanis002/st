...
ARM bool ActorUnkKLTR::func_ov026_021127e8(void) {
    ...
    if (!tmp) {
        ...
        if (this->mUnk_5C.mUnk_1A == 0 && (this->mUnk_5C.mParams[1] == 0 || func_ov026_02132010(this->mUnk_5C.mParams[1]))) {
            return true;
        }
    }
    return false;
...
ARM bool ActorUnkKLTR::func_ov026_02112bd4(void) {
    ...
    u32 randomHighWord = gRandom.Next32(0);
    ...
    if (this->mUnk_0A8.func_ov026_020fa358()) {
        if (!this->mUnk_0A8.func_ov026_020fa46c(this->mUnk_0A8.func_ov026_020fa73c(), this->mUnk_5C.mParams[2])) {
