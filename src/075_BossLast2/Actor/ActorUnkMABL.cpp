...
extern ActorTypeUnkMABL ActorTypeUnkMABL::gInstance;

ARM ActorTypeUnkMABL *ActorTypeUnkMABL::GetInstance() {
    return &ActorTypeUnkMABL::gInstance;
}

ARM Actor *ActorTypeUnkMABL::Create() {
    return new(HeapIndex_2) ActorUnkMABL();
}

ARM ActorTypeUnkMABL::ActorTypeUnkMABL() :
    ActorType(ActorId_MABL) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkMABL::ActorUnkMABL() {}

ARM void ActorUnkMABL::func_ov075_0215e324(void) {}
ARM void ActorUnkMABL::func_ov075_0215e3d8(void) {}
ARM void ActorUnkMABL::func_ov075_0215e684(void) {}
ARM void ActorUnkMABL::func_ov075_0215e698(void) {}
ARM void ActorUnkMABL::func_ov075_0215e6e4(void) {}
