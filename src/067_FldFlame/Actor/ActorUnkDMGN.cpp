...
extern ActorTypeUnkDMGN ActorTypeUnkDMGN::gInstance;

ARM ActorTypeUnkDMGN *ActorTypeUnkDMGN::GetInstance() {
    return &ActorTypeUnkDMGN::gInstance;
}

ARM Actor *ActorTypeUnkDMGN::Create() {
    return new(HeapIndex_2) ActorUnkDMGN();
}

ARM ActorTypeUnkDMGN::ActorTypeUnkDMGN() :
    ActorType(ActorId_DMGN) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkDMGN::ActorUnkDMGN() {}

ARM void ActorUnkDMGN::func_ov067_0215abcc(void) {}
ARM void ActorUnkDMGN::func_ov067_0215acd4(void) {}
ARM void ActorUnkDMGN::func_ov067_0215acfc(void) {}
