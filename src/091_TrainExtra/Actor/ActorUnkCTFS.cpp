...
extern ActorTypeUnkCTFS ActorTypeUnkCTFS::gInstance;

ARM ActorTypeUnkCTFS *ActorTypeUnkCTFS::GetInstance() {
    return &ActorTypeUnkCTFS::gInstance;
}

ARM Actor *ActorTypeUnkCTFS::Create() {
    return new(HeapIndex_2) ActorUnkCTFS();
}

ARM ActorTypeUnkCTFS::ActorTypeUnkCTFS() :
    ActorType(ActorId_CTFS) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkCTFS::ActorUnkCTFS() {}

ARM void ActorUnkCTFS::func_ov091_0216a010(void) {}
...
ARM void ActorUnkCTFS::func_ov091_0216b2a0(void) {}
ARM void ActorUnkCTFS::func_ov091_0216b2bc(void) {}
ARM void ActorUnkCTFS::func_ov091_0216b2e4(void) {}
ARM void ActorUnkCTFS::func_ov091_0216b314(void) {}
