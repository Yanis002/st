...
extern ActorTypeUnkZLBB ActorTypeUnkZLBB::gInstance;

ARM ActorTypeUnkZLBB *ActorTypeUnkZLBB::GetInstance() {
    return &ActorTypeUnkZLBB::gInstance;
}

ARM Actor *ActorTypeUnkZLBB::Create() {
    return new(HeapIndex_2) ActorUnkZLBB();
}

ARM ActorTypeUnkZLBB::ActorTypeUnkZLBB() :
    ActorType(ActorId_ZLBB) {}

ARM /* (TODO: verify if this is accurate) */ ActorUnkZLBB::ActorUnkZLBB() {}

ARM void ActorUnkZLBB::func_ov074_02155750(void) {}
...
ARM void ActorUnkZLBB::func_ov074_02156a84(void) {}
ARM void ActorUnkZLBB::func_ov074_02156af8(void) {}
ARM void ActorUnkZLBB::func_ov074_02156b74(void) {}
