...
public:
    ...
    void func_ov057_02138510(void);
    void func_ov057_0213855c(void);
    ...
    void func_ov057_02139d84(void);
    void func_ov057_02139de4(void);
    void func_ov057_02139e4c(void);
};

class ActorTypeUnkFSST : public ActorType {
public:
    static ActorTypeUnkFSST gInstance;
    ...
    static ActorTypeUnkFSST *GetInstance();
};
