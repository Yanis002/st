...
public:
    ...
    void func_ov092_02177120(void);
    void func_ov092_02177148(void);
    ...
    void func_ov092_02177c6c(void);
    void func_ov092_02177c88(void);
    void func_ov092_02177ca4(void);
    void func_ov092_02177d00(void);
    void func_ov092_02177d64(void);
};

class ActorTypeUnkTDKT : public ActorType {
public:
    static ActorTypeUnkTDKT gInstance;
    ...
    static ActorTypeUnkTDKT *GetInstance();
};
