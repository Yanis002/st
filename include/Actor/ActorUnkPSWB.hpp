...
public:
    ...
    void func_ov094_021662f8(void);
    void func_ov094_02166424(void);
    void func_ov094_02166438(void);
    void func_ov094_02166454(void);
    void func_ov094_0216657c(void);
    ...
    void func_ov094_021683c4(void);
};

class ActorTypeUnkPSWB : public ActorType {
public:
    static ActorTypeUnkPSWB gInstance;
    ...
    static ActorTypeUnkPSWB *GetInstance();
};
