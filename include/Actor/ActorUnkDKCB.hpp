...
public:
    ...
    void func_ov092_02178cb0(void);
    void func_ov092_02178cf4(void);
    ...
    void func_ov092_021796a0(void);
    void func_ov092_02179724(void);
};

class ActorTypeUnkDKCB : public ActorType {
public:
    static ActorTypeUnkDKCB gInstance;
    ...
    static ActorTypeUnkDKCB *GetInstance();
};
