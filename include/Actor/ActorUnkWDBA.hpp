...
public:
    ...
    void func_ov090_02168b7c(void);
    void func_ov090_02168bec(void);
    ...
    void func_ov090_0216d550(void);
    void func_ov090_0216d56c(void);
    ...
    void func_ov090_0216dd18(void);
};

class ActorTypeUnkWDBA : public ActorType {
public:
    static ActorTypeUnkWDBA gInstance;
    ...
    static ActorTypeUnkWDBA *GetInstance();
};
