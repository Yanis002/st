...
public:
    ...
    void func_ov026_021167f4(void);
    void func_ov026_0211685c(void);
    void func_ov026_02116a04(void);
    void func_ov026_02116b34(void);
    ...
    void func_ov026_0211a9e4(void);
};

class ActorTypeUnkTBRD : public ActorType {
public:
    static ActorTypeUnkTBRD gInstance;
    ...
    static ActorTypeUnkTBRD *GetInstance();
};
