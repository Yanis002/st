...
public:
    ...
    void func_ov092_021722d4(void);
    void func_ov092_02172420(void);
    void func_ov092_02172434(void);
    void func_ov092_021724b8(void);
    ...
    void func_ov092_021735d4(void);
};

class ActorTypeUnkMTFB : public ActorType {
public:
    static ActorTypeUnkMTFB gInstance;
    ...
    static ActorTypeUnkMTFB *GetInstance();
};
