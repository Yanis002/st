...
public:
    ...
    void func_ov064_021596bc(void);
    void func_ov064_02159740(void);
    ...
    void func_ov064_02159d40(void);
    void func_ov064_02159d5c(void);
    void func_ov064_02159d8c(void);
};

class ActorTypeUnkFOMD : public ActorType {
public:
    static ActorTypeUnkFOMD gInstance;
    ...
    static ActorTypeUnkFOMD *GetInstance();
};
