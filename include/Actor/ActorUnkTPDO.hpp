...
public:
    ...
    void func_ov091_0216d9fc(void);
    void func_ov091_0216da5c(void);
    ...
    void func_ov091_0216e548(void);
    void func_ov091_0216e564(void);
    void func_ov091_0216e5f4(void);
    void func_ov091_0216e68c(void);
};

class ActorTypeUnkTPDO : public ActorType {
public:
    static ActorTypeUnkTPDO gInstance;
    ...
    static ActorTypeUnkTPDO *GetInstance();
};
