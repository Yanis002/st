...
public:
    ...
    void func_ov026_02123ad8(void);
    void func_ov026_02123b60(void);
    ...
    void func_ov026_02127e74(void);
    void func_ov026_02127e90(void);
    void func_ov026_02127efc(void);
    void func_ov026_02127f70(void);
};

class ActorTypeUnkBDEM : public ActorType {
public:
    static ActorTypeUnkBDEM gInstance;
    ...
    static ActorTypeUnkBDEM *GetInstance();
};
