...
public:
    ...
    void func_ov086_0215afd4(void);
    void func_ov086_0215b028(void);
    ...
    void func_ov086_0215b77c(void);
    void func_ov086_0215b798(void);
    void func_ov086_0215b7c0(void);
    void func_ov086_0215b7f0(void);
};

class ActorTypeUnkOCGS : public ActorType {
public:
    static ActorTypeUnkOCGS gInstance;
    ...
    static ActorTypeUnkOCGS *GetInstance();
};
