...
public:
    ...
    void func_ov058_0214d3a4(void);
    void func_ov058_0214d3c0(void);
    void func_ov058_0214d3dc(void);
    void func_ov058_0214d414(void);
    void func_ov058_0214d454(void);
};

class ActorTypeUnkWPBD : public ActorType {
public:
    static ActorTypeUnkWPBD gInstance;
    ...
    static ActorTypeUnkWPBD *GetInstance();
};
