...
public:
    ...
    void func_ov068_02158b14(void);
    void func_ov068_02158b60(void);
    ...
    void func_ov068_02159254(void);
    void func_ov068_02159274(void);
    void func_ov068_0215929c(void);
};

class ActorTypeUnkAJAI : public ActorType {
public:
    static ActorTypeUnkAJAI gInstance;
    ...
    static ActorTypeUnkAJAI *GetInstance();
};
