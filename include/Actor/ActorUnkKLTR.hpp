...
public:
    ...
    void func_ov026_02111674(void);
    void func_ov026_021116e0(void);
    void func_ov026_021116f0(void);
    void func_ov026_0211185c(void);
    void func_ov026_021118e4(void);
    ...
    void func_ov026_02113d28(void);
};

class ActorTypeUnkKLTR : public ActorType {
public:
    static ActorTypeUnkKLTR gInstance;
    ...
    static ActorTypeUnkKLTR *GetInstance();
};
