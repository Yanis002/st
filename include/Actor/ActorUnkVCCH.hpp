...
public:
    ...
    void func_ov066_02157ed0(void);
    void func_ov066_02157f40(void);
    void func_ov066_02157f78(void);
    void func_ov066_02157f94(void);
    void func_ov066_02157fb8(void);
    void func_ov066_02157fc4(void);
    void func_ov066_02158260(void);
    ...
    void func_ov066_02158d5c(void);
    void func_ov066_02158d7c(void);
};

class ActorTypeUnkVCCH : public ActorType {
public:
    static ActorTypeUnkVCCH gInstance;
    ...
    static ActorTypeUnkVCCH *GetInstance();
};
