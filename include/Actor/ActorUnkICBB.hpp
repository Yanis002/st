...
public:
    ...
    void func_ov044_0212a42c(void);
};

class ActorTypeUnkICBB : public ActorType {
public:
    static ActorTypeUnkICBB gInstance;
    ...
    static ActorTypeUnkICBB *GetInstance();
};
