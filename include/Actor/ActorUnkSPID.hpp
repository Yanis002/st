...
public:
    ...
    void func_ov090_0216f500(void);
    void func_ov090_0216f57c(void);
    ...
    void func_ov090_02170ec8(void);
    void func_ov090_02170ee4(void);
    void func_ov090_02170f00(void);
    void func_ov090_02170f30(void);
    void func_ov090_02170f68(void);
};

class ActorTypeUnkSPID : public ActorType {
public:
    static ActorTypeUnkSPID gInstance;
    ...
    static ActorTypeUnkSPID *GetInstance();
};
