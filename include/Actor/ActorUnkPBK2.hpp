...
public:
    ...
    void func_ov048_02132118(void);
    void func_ov048_02132170(void);
    void func_ov048_02132298(void);
    void func_ov048_02132320(void);
...
class ActorTypeUnkPBK2 : public ActorType {
public:
    static ActorTypeUnkPBK2 gInstance;
    ...
    static ActorTypeUnkPBK2 *GetInstance();
};
