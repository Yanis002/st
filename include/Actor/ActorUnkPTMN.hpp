...
public:
    ...
    void func_ov049_02136b0c(void);
};

class ActorTypeUnkPTMN : public ActorType {
public:
    static ActorTypeUnkPTMN gInstance;
    ...
    static ActorTypeUnkPTMN *GetInstance();
};
