...
public:
    ...
    void func_ov077_0215aa28(void);
    void func_ov077_0215aa44(void);
    void func_ov077_0215aa60(void);
    void func_ov077_0215aa88(void);
    void func_ov077_0215aab8(void);
};

class ActorTypeUnkPMST : public ActorType {
public:
    static ActorTypeUnkPMST gInstance;
    ...
    static ActorTypeUnkPMST *GetInstance();
};
