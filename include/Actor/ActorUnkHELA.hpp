...
public:
    ...
    void func_ov030_0214afd8(void);
    void func_ov030_0214aff4(void);
    void func_ov030_0214b03c(void);
    void func_ov030_0214b08c(void);
    void func_ov030_0214b0a4(void);
    void func_ov030_0214b0b8(void);
};

class ActorTypeUnkHELA : public ActorType {
public:
    static ActorTypeUnkHELA gInstance;
    ...
    static ActorTypeUnkHELA *GetInstance();
};
