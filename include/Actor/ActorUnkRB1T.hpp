...
public:
    ...
    void func_ov026_0211e128(void);
    void func_ov026_0211e198(void);
    ...
    void func_ov026_0212098c(void);
    void func_ov026_021209a8(void);
    void func_ov026_021209d8(void);
    void func_ov026_02120a10(void);
    void func_ov026_02120a38(void);
    void func_ov026_02120a58(void);
};

class ActorTypeUnkRB1T : public ActorType {
public:
    static ActorTypeUnkRB1T gInstance;
    ...
    static ActorTypeUnkRB1T *GetInstance();
};
