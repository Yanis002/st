...
public:
    ...
    void func_ov029_02146b34(void);
    void func_ov029_02146b9c(void);
    ...
    void func_ov029_02149cb8(void);
};

class ActorTypeUnkDLPN : public ActorType {
public:
    static ActorTypeUnkDLPN gInstance;
    ...
    static ActorTypeUnkDLPN *GetInstance();
};
