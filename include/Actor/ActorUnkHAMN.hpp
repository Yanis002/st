...
public:
    ...
    void func_ov086_02154af4(void);
    void func_ov086_02154b44(void);
    ...
    void func_ov086_0215805c(void);
};

class ActorTypeUnkHAMN : public ActorType {
public:
    static ActorTypeUnkHAMN gInstance;
    ...
    static ActorTypeUnkHAMN *GetInstance();
};
