...
public:
    ...
    void func_ov046_02124df8(void);
    void func_ov046_02124e48(void);
    void func_ov046_02125084(void);
    void func_ov046_02125104(void);
    ...
    void func_ov046_021264f0(void);
};

class ActorTypeUnkWTH2 : public ActorType {
public:
    static ActorTypeUnkWTH2 gInstance;
    ...
    static ActorTypeUnkWTH2 *GetInstance();
};
