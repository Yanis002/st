...
public:
    ...
    void func_ov070_021413e4(void);
    void func_ov070_0214143c(void);
    void func_ov070_021414e8(void);
    ...
    void func_ov070_021426c8(void);
    void func_ov070_021426f0(void);
    void func_ov070_02142720(void);
};

class ActorTypeUnkKEYN : public ActorType {
public:
    static ActorTypeUnkKEYN gInstance;
    ...
    static ActorTypeUnkKEYN *GetInstance();
};
