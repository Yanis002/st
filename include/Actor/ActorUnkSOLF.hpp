...
public:
    ...
    void func_ov037_0211e7c8(void);
    void func_ov037_0211e7e4(void);
    void func_ov037_0211e800(void);
    ...
    void func_ov037_0211e90c(void);
    void func_ov037_0211e92c(void);
};

class ActorTypeUnkSOLF : public ActorType {
public:
    static ActorTypeUnkSOLF gInstance;
    ...
    static ActorTypeUnkSOLF *GetInstance();
};
