...
public:
    ...
    void func_ov087_0215b1e4(void);
    void func_ov087_0215b24c(void);
    void func_ov087_0215b430(void);
    void func_ov087_0215b444(void);
    void func_ov087_0215b458(void);
    void func_ov087_0215b4d4(void);
    ...
    void func_ov087_0215c284(void);
};

class ActorTypeUnkDSBB : public ActorType {
public:
    static ActorTypeUnkDSBB gInstance;
    ...
    static ActorTypeUnkDSBB *GetInstance();
};
