...
public:
    ...
    void func_ov043_02128274(void);
    void func_ov043_02128290(void);
    void func_ov043_021282ac(void);
    void func_ov043_021282ec(void);
    void func_ov043_02128334(void);
};

class ActorTypeUnkSTFH : public ActorType {
public:
    static ActorTypeUnkSTFH gInstance;
    ...
    static ActorTypeUnkSTFH *GetInstance();
};
