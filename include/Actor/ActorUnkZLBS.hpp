...
public:
    ...
    void func_ov074_02152e7c(void);
    void func_ov074_02152ee4(void);
    void func_ov074_021531fc(void);
    void func_ov074_02153210(void);
    void func_ov074_021532fc(void);
    ...
    void func_ov074_021556c8(void);
};

class ActorTypeUnkZLBS : public ActorType {
public:
    static ActorTypeUnkZLBS gInstance;
    ...
    static ActorTypeUnkZLBS *GetInstance();
};
