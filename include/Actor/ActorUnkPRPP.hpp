...
public:
    ...
    void func_ov081_02151a90(void);
    void func_ov081_02151ad4(void);
    ...
    void func_ov081_02151fd4(void);
    void func_ov081_02151fe8(void);
};

class ActorTypeUnkPRPP : public ActorType {
public:
    static ActorTypeUnkPRPP gInstance;
    ...
    static ActorTypeUnkPRPP *GetInstance();
};
