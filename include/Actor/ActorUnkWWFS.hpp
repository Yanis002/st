...
public:
    ...
    void func_ov038_0211cd84(void);
};

class ActorTypeUnkWWFS : public ActorType {
public:
    static ActorTypeUnkWWFS gInstance;
    ...
    static ActorTypeUnkWWFS *GetInstance();
};
