...
public:
    ...
    void func_ov059_02158b80(void);
    void func_ov059_02158bcc(void);
    ...
    void func_ov059_0215c1ec(void);
    void func_ov059_0215c208(void);
    ...
    void func_ov059_0215c424(void);
};

class ActorTypeUnkPSEM : public ActorType {
public:
    static ActorTypeUnkPSEM gInstance;
    ...
    static ActorTypeUnkPSEM *GetInstance();
};
