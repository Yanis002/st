...
public:
    ...
    void func_ov091_0216b358(void);
    void func_ov091_0216b3bc(void);
    void func_ov091_0216b3cc(void);
    void func_ov091_0216b4d8(void);
    void func_ov091_0216b518(void);
    void func_ov091_0216b52c(void);
    void func_ov091_0216b580(void);
    void func_ov091_0216b604(void);
    ...
    void func_ov091_0216c004(void);
};

class ActorTypeUnkNLTR : public ActorType {
public:
    static ActorTypeUnkNLTR gInstance;
    ...
    static ActorTypeUnkNLTR *GetInstance();
};
