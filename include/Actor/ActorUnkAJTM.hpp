...
public:
    ...
    void func_ov068_0215c098(void);
    void func_ov068_0215c0e8(void);
    void func_ov068_0215c1ac(void);
    void func_ov068_0215c1d0(void);
    ...
    void func_ov068_0215cfa0(void);
};

class ActorTypeUnkAJTM : public ActorType {
public:
    static ActorTypeUnkAJTM gInstance;
    ...
    static ActorTypeUnkAJTM *GetInstance();
};
