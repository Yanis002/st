...
public:
    ...
    void func_ov032_0211b6fc(void);
    void func_ov032_0211b748(void);
    void func_ov032_0211b920(void);
    void func_ov032_0211b950(void);
    ...
    void func_ov032_0211db2c(void);
};

class ActorTypeUnkMKUR : public ActorType {
public:
    static ActorTypeUnkMKUR gInstance;
    ...
    static ActorTypeUnkMKUR *GetInstance();
};
