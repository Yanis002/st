...
public:
    ...
    void func_ov046_02127870(void);
    void func_ov046_021278c0(void);
    void func_ov046_02127a00(void);
    void func_ov046_02127a14(void);
    void func_ov046_02127a28(void);
    void func_ov046_02127a84(void);
    ...
    void func_ov046_0212887c(void);
};

class ActorTypeUnkWBTN : public ActorType {
public:
    static ActorTypeUnkWBTN gInstance;
    ...
    static ActorTypeUnkWBTN *GetInstance();
};
