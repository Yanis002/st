...
public:
    ...
    void func_ov091_0216f0cc(void);
    void func_ov091_0216f150(void);
    void func_ov091_0216f51c(void);
    void func_ov091_0216f530(void);
    void func_ov091_0216f544(void);
    void func_ov091_0216f5cc(void);
    ...
    void func_ov091_021757cc(void);
};

class ActorTypeUnkTTKB : public ActorType {
public:
    static ActorTypeUnkTTKB gInstance;
    ...
    static ActorTypeUnkTTKB *GetInstance();
};
