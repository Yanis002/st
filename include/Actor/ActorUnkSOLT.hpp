...
public:
    ...
    void func_ov037_0211e970(void);
    void func_ov037_0211e9c8(void);
    ...
    void func_ov037_0212094c(void);
    void func_ov037_02120974(void);
    void func_ov037_021209a4(void);
};

class ActorTypeUnkSOLT : public ActorType {
public:
    static ActorTypeUnkSOLT gInstance;
    ...
    static ActorTypeUnkSOLT *GetInstance();
};
