...
public:
    ...
    void func_ov031_020f9cd8(void);
    void func_ov031_020f9cf4(void);
    void func_ov031_020f9d10(void);
    void func_ov031_020f9d60(void);
    void func_ov031_020f9db8(void);
};

class ActorTypeUnkRLST : public ActorType {
public:
    static ActorTypeUnkRLST gInstance;
    ...
    static ActorTypeUnkRLST *GetInstance();
};
