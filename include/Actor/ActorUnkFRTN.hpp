...
public:
    ...
    void func_ov050_02135344(void);
    void func_ov050_02135390(void);
    ...
    void func_ov050_02136194(void);
    void func_ov050_021361b0(void);
    void func_ov050_021361e0(void);
};

class ActorTypeUnkFRTN : public ActorType {
public:
    static ActorTypeUnkFRTN gInstance;
    ...
    static ActorTypeUnkFRTN *GetInstance();
};
