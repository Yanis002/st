...
public:
    ...
    void func_ov054_02138594(void);
    void func_ov054_021385d8(void);
    ...
    void func_ov054_0213c0ec(void);
    void func_ov054_0213c108(void);
    void func_ov054_0213c184(void);
    void func_ov054_0213c208(void);
};

class ActorTypeUnkFBBH : public ActorType {
public:
    static ActorTypeUnkFBBH gInstance;
    ...
    static ActorTypeUnkFBBH *GetInstance();
};
