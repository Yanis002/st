...
public:
    ...
    void func_ov037_021209e8(void);
    void func_ov037_02120a10(void);
    void func_ov037_02120a64(void);
    void func_ov037_02120a90(void);
    ...
    void func_ov037_02121b4c(void);
    void func_ov037_02121b74(void);
};

class ActorTypeUnkTUTO : public ActorType {
public:
    static ActorTypeUnkTUTO gInstance;
    ...
    static ActorTypeUnkTUTO *GetInstance();
};
