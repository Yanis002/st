...
public:
    ...
    void func_ov079_02152f98(void);
    void func_ov079_02152fec(void);
    void func_ov079_02153230(void);
    void func_ov079_02153244(void);
    void func_ov079_021532dc(void);
    ...
    void func_ov079_021550c4(void);
};

class ActorTypeUnkOCTW : public ActorType {
public:
    static ActorTypeUnkOCTW gInstance;
    ...
    static ActorTypeUnkOCTW *GetInstance();
};
