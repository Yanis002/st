...
public:
    ...
    void func_ov058_0214a974(void);
};

class ActorTypeUnkFBRD : public ActorType {
public:
    static ActorTypeUnkFBRD gInstance;
    ...
    static ActorTypeUnkFBRD *GetInstance();
};
