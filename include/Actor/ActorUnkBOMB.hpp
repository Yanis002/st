...
public:
    ...
    void func_ov031_020e2db4(void);
    void func_ov031_020e2dd0(void);
    ...
    void func_ov031_020e34a0(void);
};

class ActorTypeUnkBOMB : public ActorType {
public:
    static ActorTypeUnkBOMB gInstance;
    ...
    static ActorTypeUnkBOMB *GetInstance();
};
