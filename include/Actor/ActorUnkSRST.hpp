...
public:
    ...
    void func_ov085_02150fbc(void);
    void func_ov085_0215101c(void);
    ...
    void func_ov085_021530e0(void);
    void func_ov085_021530fc(void);
    void func_ov085_02153118(void);
    void func_ov085_02153158(void);
};

class ActorTypeUnkSRST : public ActorType {
public:
    static ActorTypeUnkSRST gInstance;
    ...
    static ActorTypeUnkSRST *GetInstance();
};
