...
public:
    ...
    void func_ov059_02160d98(void);
    void func_ov059_02160db4(void);
    void func_ov059_02160ddc(void);
    void func_ov059_02160dfc(void);
};

class ActorTypeUnkPSNP : public ActorType {
public:
    static ActorTypeUnkPSNP gInstance;
    ...
    static ActorTypeUnkPSNP *GetInstance();
};
