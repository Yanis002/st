...
public:
    ...
    void func_ov054_0213c24c(void);
    void func_ov054_0213c2a0(void);
    ...
    void func_ov054_0213d584(void);
    void func_ov054_0213d5b4(void);
    void func_ov054_0213d5ec(void);
};

class ActorTypeUnkFIBB : public ActorType {
public:
    static ActorTypeUnkFIBB gInstance;
    ...
    static ActorTypeUnkFIBB *GetInstance();
};
