...
public:
    ...
    void func_ov096_0217ad64(void);
    void func_ov096_0217adb8(void);
    void func_ov096_0217add8(void);
    void func_ov096_0217ae50(void);
    ...
    void func_ov096_0217d180(void);
    void func_ov096_0217d19c(void);
    void func_ov096_0217d1b8(void);
    void func_ov096_0217d1d4(void);
    void func_ov096_0217d234(void);
};

class ActorTypeUnkBPBS : public ActorType {
public:
    static ActorTypeUnkBPBS gInstance;
    ...
    static ActorTypeUnkBPBS *GetInstance();
};
