...
public:
    ...
    void func_ov087_0215c2c8(void);
    void func_ov087_0215c33c(void);
    ...
    void func_ov087_02160988(void);
    void func_ov087_021609a4(void);
    ...
    void func_ov087_02161164(void);
};

class ActorTypeUnkDSBH : public ActorType {
public:
    static ActorTypeUnkDSBH gInstance;
    ...
    static ActorTypeUnkDSBH *GetInstance();
};
