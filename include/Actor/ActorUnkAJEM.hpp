...
public:
    ...
    void func_ov068_021592e0(void);
    void func_ov068_02159338(void);
    ...
    void func_ov068_0215a7bc(void);
    void func_ov068_0215a7d8(void);
    void func_ov068_0215a800(void);
    void func_ov068_0215a830(void);
};

class ActorTypeUnkAJEM : public ActorType {
public:
    static ActorTypeUnkAJEM gInstance;
    ...
    static ActorTypeUnkAJEM *GetInstance();
};
