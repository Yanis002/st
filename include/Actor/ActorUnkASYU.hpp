...
public:
    ...
    void func_ov077_02156f68(void);
};

class ActorTypeUnkASYU : public ActorType {
public:
    static ActorTypeUnkASYU gInstance;
    ...
    static ActorTypeUnkASYU *GetInstance();
};
