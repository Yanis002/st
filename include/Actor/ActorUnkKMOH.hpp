...
public:
    ...
    void func_ov050_02132ef0(void);
    void func_ov050_02132f3c(void);
    ...
    void func_ov050_021351e4(void);
    void func_ov050_02135200(void);
    void func_ov050_0213527c(void);
    void func_ov050_02135300(void);
};

class ActorTypeUnkKMOH : public ActorType {
public:
    static ActorTypeUnkKMOH gInstance;
    ...
    static ActorTypeUnkKMOH *GetInstance();
};
