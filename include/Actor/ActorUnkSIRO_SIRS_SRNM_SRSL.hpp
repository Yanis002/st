...
class ActorProfileUnkSIRO : public ActorProfile {
public:
    /* 00 (base) */
...
class ActorProfileUnkSIRS : public ActorProfile {
public:
    /* 00 (base) */
...
class ActorProfileUnkSRNM : public ActorProfile {
public:
    /* 00 (base) */
...
class ActorProfileUnkSRSL : public ActorProfile {
public:
    /* 00 (base) */
