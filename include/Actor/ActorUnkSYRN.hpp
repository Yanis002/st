...
public:
    ...
    void func_ov094_02169570(void);
    void func_ov094_021695e8(void);
    void func_ov094_02169854(void);
    void func_ov094_02169868(void);
    void func_ov094_0216987c(void);
    void func_ov094_021698e0(void);
    ...
    void func_ov094_0216a0e0(void);
    void func_ov094_0216a100(void);
    void func_ov094_0216a114(void);
    void func_ov094_0216a14c(void);
};

class ActorTypeUnkSYRN : public ActorType {
public:
    static ActorTypeUnkSYRN gInstance;
    ...
    static ActorTypeUnkSYRN *GetInstance();
};
