...
public:
    ...
    void func_ov032_02118ff0(void);
    void func_ov032_0211904c(void);
    void func_ov032_02119248(void);
    void func_ov032_0211925c(void);
    void func_ov032_02119270(void);
    void func_ov032_021192fc(void);
    ...
    void func_ov032_0211b6b8(void);
};

class ActorTypeUnkKURI : public ActorType {
public:
    static ActorTypeUnkKURI gInstance;
    ...
    static ActorTypeUnkKURI *GetInstance();
};
