...
public:
    ...
    void func_ov094_0216c65c(void);
    void func_ov094_0216c6ac(void);
    void func_ov094_0216c7cc(void);
    void func_ov094_0216c7e0(void);
    void func_ov094_0216c800(void);
    ...
    void func_ov094_0216daac(void);
};

class ActorTypeUnkSPTG : public ActorType {
public:
    static ActorTypeUnkSPTG gInstance;
    ...
    static ActorTypeUnkSPTG *GetInstance();
};
