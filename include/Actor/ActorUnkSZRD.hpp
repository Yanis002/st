...
public:
    ...
    void func_ov090_02165ad8(void);
    void func_ov090_02165dec(void);
    void func_ov090_02165e00(void);
    void func_ov090_02165e14(void);
    void func_ov090_02165e90(void);
    ...
    void func_ov090_02168b38(void);
};

class ActorTypeUnkSZRD : public ActorType {
public:
    static ActorTypeUnkSZRD gInstance;
    ...
    static ActorTypeUnkSZRD *GetInstance();
};
