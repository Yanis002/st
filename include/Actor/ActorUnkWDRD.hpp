...
public:
    ...
    void func_ov090_0216dd5c(void);
    void func_ov090_0216ddc8(void);
    ...
    void func_ov090_0216f454(void);
    void func_ov090_0216f484(void);
    void func_ov090_0216f4bc(void);
};

class ActorTypeUnkWDRD : public ActorType {
public:
    static ActorTypeUnkWDRD gInstance;
    ...
    static ActorTypeUnkWDRD *GetInstance();
};
