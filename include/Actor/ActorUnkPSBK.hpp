...
public:
    ...
    void func_ov048_02130c10(void);
    void func_ov048_02130d34(void);
    void func_ov048_02130d48(void);
    void func_ov048_02130d64(void);
    void func_ov048_02130f10(void);
    ...
    void func_ov048_021320d4(void);
};

class ActorTypeUnkPSBK : public ActorType {
public:
    static ActorTypeUnkPSBK gInstance;
    ...
    static ActorTypeUnkPSBK *GetInstance();
};
