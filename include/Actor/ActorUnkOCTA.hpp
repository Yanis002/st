...
public:
    ...
    void func_ov042_02123c7c(void);
    void func_ov042_02123cd0(void);
    ...
    void func_ov042_02125078(void);
    void func_ov042_02125094(void);
    void func_ov042_02125110(void);
    void func_ov042_02125194(void);
};

class ActorTypeUnkOCTA : public ActorType {
public:
    static ActorTypeUnkOCTA gInstance;
    ...
    static ActorTypeUnkOCTA *GetInstance();
};
