...
public:
    ...
    void func_ov074_0215d780(void);
    void func_ov074_0215d7c0(void);
    ...
    void func_ov074_0215e5d0(void);
    void func_ov074_0215e5ec(void);
    void func_ov074_0215e62c(void);
    void func_ov074_0215e674(void);
};

class ActorTypeUnkKIMB : public ActorType {
public:
    static ActorTypeUnkKIMB gInstance;
    ...
    static ActorTypeUnkKIMB *GetInstance();
};
