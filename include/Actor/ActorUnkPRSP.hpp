...
public:
    ...
    void func_ov029_0214d8d8(void);
    void func_ov029_0214d954(void);
    ...
    void func_ov029_02150dac(void);
    void func_ov029_02150dc8(void);
    void func_ov029_02150de4(void);
    void func_ov029_02150e2c(void);
};

class ActorTypeUnkPRSP : public ActorType {
public:
    static ActorTypeUnkPRSP gInstance;
    ...
    static ActorTypeUnkPRSP *GetInstance();
};
