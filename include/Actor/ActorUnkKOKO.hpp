...
public:
    ...
    void func_ov058_0213f284(void);
    void func_ov058_0213f2f0(void);
    void func_ov058_0213f324(void);
    ...
    void func_ov058_02141dc4(void);
};

class ActorTypeUnkKOKO : public ActorType {
public:
    static ActorTypeUnkKOKO gInstance;
    ...
    static ActorTypeUnkKOKO *GetInstance();
};
