...
public:
    ...
    void func_ov045_021241b8(void);
    void func_ov045_02124214(void);
    void func_ov045_0212425c(void);
    ...
    void func_ov045_021277b0(void);
    void func_ov045_021277cc(void);
    void func_ov045_021277e8(void);
    void func_ov045_02127804(void);
    void func_ov045_02127850(void);
    void func_ov045_021278a4(void);
};

class ActorTypeUnkBDGA : public ActorType {
public:
    static ActorTypeUnkBDGA gInstance;
    ...
    static ActorTypeUnkBDGA *GetInstance();
};
