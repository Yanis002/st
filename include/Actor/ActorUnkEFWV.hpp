...
public:
    ...
    void func_ov098_02181598(void);
    void func_ov098_021815d0(void);
    ...
    void func_ov098_02181674(void);
};

class ActorTypeUnkEFWV : public ActorType {
public:
    static ActorTypeUnkEFWV gInstance;
    ...
    static ActorTypeUnkEFWV *GetInstance();
};
