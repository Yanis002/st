...
public:
    ...
    void func_ov042_021288ec(void);
    void func_ov042_02128938(void);
    ...
    void func_ov042_0212b51c(void);
    void func_ov042_0212b538(void);
    void func_ov042_0212b5b4(void);
};

class ActorTypeUnkPHEY : public ActorType {
public:
    static ActorTypeUnkPHEY gInstance;
    ...
    static ActorTypeUnkPHEY *GetInstance();
};
