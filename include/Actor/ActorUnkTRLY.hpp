...
public:
    ...
    void func_ov034_0211a34c(void);
    void func_ov034_0211a394(void);
    void func_ov034_0211a3a8(void);
    ...
    void func_ov034_0211e2ec(void);
};

class ActorTypeUnkTRLY : public ActorType {
public:
    static ActorTypeUnkTRLY gInstance;
    ...
    static ActorTypeUnkTRLY *GetInstance();
};
