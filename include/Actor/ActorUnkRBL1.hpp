...
public:
    ...
    void func_ov074_02151a30(void);
    void func_ov074_02151a4c(void);
    void func_ov074_02151a68(void);
    void func_ov074_02151ab0(void);
    void func_ov074_02151b00(void);
};

class ActorTypeUnkRBL1 : public ActorType {
public:
    static ActorTypeUnkRBL1 gInstance;
    ...
    static ActorTypeUnkRBL1 *GetInstance();
};
