...
public:
    ...
    void func_ov041_0212a7c8(void);
    void func_ov041_0212a7f0(void);
    ...
    void func_ov041_0212b954(void);
    void func_ov041_0212b968(void);
};

class ActorTypeUnkRPMT : public ActorType {
public:
    static ActorTypeUnkRPMT gInstance;
    ...
    static ActorTypeUnkRPMT *GetInstance();
};
