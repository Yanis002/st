...
public:
    ...
    void func_ov059_0215c46c(void);
    void func_ov059_0215c4c4(void);
    ...
    void func_ov059_02160384(void);
    void func_ov059_021603a0(void);
    void func_ov059_021603f0(void);
    void func_ov059_02160448(void);
};

class ActorTypeUnkPSBS : public ActorType {
public:
    static ActorTypeUnkPSBS gInstance;
    ...
    static ActorTypeUnkPSBS *GetInstance();
};
