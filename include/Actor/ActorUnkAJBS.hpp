...
public:
    ...
    void func_ov068_0215e940(void);
    void func_ov068_0215e994(void);
    ...
    void func_ov068_02160330(void);
    void func_ov068_0216034c(void);
    void func_ov068_02160384(void);
    void func_ov068_021603c4(void);
};

class ActorTypeUnkAJBS : public ActorType {
public:
    static ActorTypeUnkAJBS gInstance;
    ...
    static ActorTypeUnkAJBS *GetInstance();
};
